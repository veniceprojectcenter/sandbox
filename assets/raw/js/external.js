...
window.visualize.Map = Map;
window.visualize.Donut = Donut;
window.visualize.Bar = Bar;
window.visualize.Counter = Counter;
window.visualize.PieChartMap = PieChartMap;
window.visualize.Firebase = Firebase;
window.visualize.Main = Main;
